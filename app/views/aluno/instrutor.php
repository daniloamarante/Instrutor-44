    ...
    <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
        <div class="flex items-start mb-6">
            ...
            <div class="flex-1">
                ...
                <div class="text-gray-600 space-y-1">
                    ...
                    <p><i class="fas fa-envelope mr-2"></i><?php echo htmlspecialchars($data['instructor']->email); ?></p>
        ...
        <div class="border-t pt-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <p class="font-semibold mb-2"><i class="fas fa-id-card mr-2 text-blue-600"></i>DETRAN</p>
                    <p class="text-gray-700"><?php echo htmlspecialchars($data['instructor']->detran_number); ?></p>
                </div>
                
                <div class="bg-gray-50 p-4 rounded-lg">
                    <p class="font-semibold mb-2"><i class="fas fa-check-circle mr-2 text-green-600"></i>Status</p>
                    <p class="text-green-700 font-semibold">Verificado pelo DETRAN</p>
                </div>
            </div>
        </div>
            ...
            <div class="border-b pb-6 last:border-b-0">
                <div class="flex items-start mb-2">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-700 mt-2">
                            <div>
