...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-bold mb-8">Minha Agenda</h1>
    
    <?php if(empty($data['schedules'])): ?>
        <div class="bg-white rounded-lg shadow-lg p-12 text-center">
            <i class="fas fa-calendar-times text-gray-400 text-6xl mb-4"></i>
            <p class="text-xl text-gray-600">Você ainda não tem aulas agendadas</p>
        </div>
    <?php else: ?>
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        <div class="flex items-center mb-4">
                            <div class="w-16 h-16 bg-gray-300 rounded-full flex items-center justify-center text-xl font-bold text-gray-600 mr-4">
                                <?php echo strtoupper(substr($schedule->student_name, 0, 1)); ?>
                            </div>
                            <div>
                                <h3 class="text-xl font-semibold"><?php echo htmlspecialchars($schedule->student_name); ?></h3>
                                <p class="text-gray-600"><?php echo htmlspecialchars($schedule->student_phone); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="text-right ml-6">
                        ...
                        <?php elseif($schedule->status == 'confirmado'): ?>
